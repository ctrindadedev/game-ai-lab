...
Pelo mesmo motivo, liberar uma área da memória precisa de um atraso.
...
Medir o tempo médio de quadro variando o número de inimigos (dezenas, centenas,
milhares), em duas condições: com a janela ativa e com todas as áreas forçadas
a ativas. A linha de base deve crescer linearmente com $N$; a janela ativa, bem
mais devagar. Repetir numa malha maior mostra o ganho assintótico. A distância
entre as duas curvas é o resultado que justifica a arquitetura.
